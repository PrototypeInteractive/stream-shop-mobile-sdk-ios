#
#  Be sure to run `pod spec lint FluxMobile.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Shahbaz Sajjad" => "shahbaz.sajjad@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/PrototypeInteractive/stream-shop-mobile-sdk-ios.git", :tag => "#{spec.version}" }
  ...
  spec.vendored_frameworks = "FluxMobileStaging.xcframework"
